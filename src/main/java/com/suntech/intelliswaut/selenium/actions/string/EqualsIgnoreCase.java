	...
	public boolean run(HashMap<String, Object> params) throws Exception {
		try{
			...
			if(text1.equalsIgnoreCase(text2)){
				Log.info("Text1 is "+text1 + " and Text2 is "+text2  +" , Text1 EqualsIngnoreCase Text2");
				return true;
			}else{
				Log.info("Text1 is "+text1 + " and Text2 is "+text2  +" , Text1 does not EqualsIngnoreCase Text2");
				return false;
			}			
		}
		catch (Exception e) {
